...
@Component({
  selector: 'app-employee-profile-onlyfor-admin',
  templateUrl: './employee-profile-onlyfor-admin.component.html',
  styleUrls: ['./employee-profile-onlyfor-admin.component.css']
})
export class EmployeeProfileOnlyforAdminComponent implements OnInit {
  ...
  addQuality(email) {
    ...
    console.log(this.qualities.value.quality)
    console.log(id)
